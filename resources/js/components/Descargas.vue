<template>
    <div>
        <div class="container" style="margin-top: 23px;">
            ...
            <div class="row d-flex flex-wrap" style="margin-top: 42px; margin-bottom: 192px;" >
                    <div v-for="descarga in descargas" :key="descarga.id" class="justify-content-around col-lg-4 ">
                        <div 
                            class="descarga tarjeta d-flex justify-content-between align-items-center" >
                            <div>
