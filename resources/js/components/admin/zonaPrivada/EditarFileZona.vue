<template>
    <div class="container">
        ...
        <div class="w-100 border-bottom">
            <h1>EDITAR ARCHIVO ZONA PRIVADA</h1>
        </div>
        ...
        <form class="mt-3">
            <div class="row">
                ...
                <input type="text" class="form-control" id="Npedido" :value="this.descarga.numeropedido">
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        updateDescarga() {
            ...
            formData.append('idFileZona', this.idDescarga);
            formData.append('file', this.foto);
            formData.append('orden', $('#orden').val());
            formData.append('Npedido', $('#Npedido').val());


            axios.post('/api/updateFileZona', formData, {
                headers: {
                ...
                .then(response => {
                    ...
                    this.$store.commit('setMensajeAlerta', 'Archivo modificado con éxito');
                    this.$store.commit('mostrarComponente', 108);
        ...
        obtenerDescarga() {
            axios.get(`/api/obtenerFileZona/${this.idDescarga}`)
                .then(response => {
