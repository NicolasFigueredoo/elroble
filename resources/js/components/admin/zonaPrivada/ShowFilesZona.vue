<template>
    <div class="container">
        ...
        <div class="w-100 border-bottom d-flex justify-content-between">
            <h1>ARCHIVOS ZONA PRIVADA</h1>

            <button @click="crearDescarga()" type="button" class="btn mb-1"
                 id="crearDescarga"   style="background-color:  #7F7F7F; color: white;">Crear File</button>
        </div>
        ...
        <table class="table table-bordered mt-3">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="col-lg-2 encabezado">Numero pedido</th>
                    <th scope="col" class="col-lg-2 encabezado">Formato</th>
                    <th scope="col" class="col-lg-2 encabezado">Peso</th>
...
export default {
    ...
    computed: {
        ...
        filteredDescargas() {
            ...
            return descarga.numeropedido.includes(this.search.toLowerCase());
    });
  }
    },
    methods: {
        ...
        axios.post('/api/deleteDescarga',{
            idDescarga: idDescarga
                ...
                .then(response => {
                    ...
                    this.$store.commit('setMensajeAlerta', 'Archivo eliminado con éxito');  
        ...
        crearDescarga(){
            this.$store.commit('mostrarComponente', 110);
        },
        getImagen(fileName) {
            if(fileName){
