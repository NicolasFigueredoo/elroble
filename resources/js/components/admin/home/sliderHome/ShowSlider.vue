    ...
    <div class="container">
        ...
        <div class="w-100 border-bottom d-flex justify-content-between">
            ...
            <button @click="crearSlider()" type="button" class="btn mb-1"
                 id="crearSlider"   style="background-color:  rgb(0, 0, 0,0.5); color: white;">Crear Slider</button>
        </div>
        ...
        <table class="table table-bordered mt-3">
            ...
            <tbody>
                <tr v-for="slider in filteredSliders" :key="slider.id">
                    ...
                    <td>
                        <button type="button" class="btn btn-sm" style="background-color: white; border: 1px solid  rgb(0, 0, 0,0.5); "
                            @click="editarSlider(2, slider.id)">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="15" height="15"
                                style="cursor: pointer">
                                <path fill=" rgb(0, 0, 0,0.5);"
                        ...
                        <button type="button" class="btn btn-sm btn-danger" style="margin-left: 15px; background-color: rgb(0, 0, 0,0.5); border:0px " @click="eliminarSlider(slider.id)">
