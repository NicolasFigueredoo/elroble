<template>
    <div class="container">
        ...
        <div class="w-100 border-bottom d-flex justify-content-between">
            ...
            <button @click="crearProducto()" type="button" class="btn mb-1"
                 id="crearProducto"   style="background-color:  rgb(0, 0, 0,0.5); color: white;">Crear Producto</button>
        </div>
        ...
        <table class="table table-bordered mt-3">
            ...
            <tbody>
                <tr v-for="producto in filteredProductos" :key="producto.id">
                    ...
                    <td>
                        <button type="button" class="btn btn-sm" style="background-color: #7F7F7F" @click="editarProducto(26, producto.id)">
